...
[output] string
	...
	PSEUDO CODE
	 1 - declare previous = 1, result;
	 2 - subs 1 to the first letter, 
   3 - rest: subst prev val
   4 - add 26  til range a =97 z=122
   5 - Convert the values back to letters.
...
function decrypt(word) {
  ...
  for(var i=0; i< word.length; i++) {
  	// gets char value in ascii
    var asciiVal = word.charCodeAt(i);
    // 
    var cur = asciiVal - prev;
